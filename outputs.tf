output "hdinsight_hbase_clusters_id" {
  description = "Map of id values across all hdinsight_hbase_clusters, keyed the same as var.hdinsight_hbase_clusters"
  value       = { for k, v in azurerm_hdinsight_hbase_cluster.hdinsight_hbase_clusters : k => v.id if v.id != null && length(v.id) > 0 }
}
output "hdinsight_hbase_clusters_cluster_version" {
  ...
  value       = { for k, v in azurerm_hdinsight_hbase_cluster.hdinsight_hbase_clusters : k => v.cluster_version if v.cluster_version != null && length(v.cluster_version) > 0 }
}
output "hdinsight_hbase_clusters_component_version" {
  ...
  value       = { for k, v in azurerm_hdinsight_hbase_cluster.hdinsight_hbase_clusters : k => one(v.component_version) if v.component_version != null && length(v.component_version) > 0 }
}
output "hdinsight_hbase_clusters_compute_isolation" {
  ...
  value       = { for k, v in azurerm_hdinsight_hbase_cluster.hdinsight_hbase_clusters : k => one(v.compute_isolation) if v.compute_isolation != null && length(v.compute_isolation) > 0 }
}
output "hdinsight_hbase_clusters_disk_encryption" {
  ...
  value       = { for k, v in azurerm_hdinsight_hbase_cluster.hdinsight_hbase_clusters : k => v.disk_encryption if v.disk_encryption != null && length(v.disk_encryption) > 0 }
}
output "hdinsight_hbase_clusters_extension" {
  ...
  value       = { for k, v in azurerm_hdinsight_hbase_cluster.hdinsight_hbase_clusters : k => one(v.extension) if v.extension != null && length(v.extension) > 0 }
  sensitive   = true
}
output "hdinsight_hbase_clusters_gateway" {
  ...
  value       = { for k, v in azurerm_hdinsight_hbase_cluster.hdinsight_hbase_clusters : k => one(v.gateway) if v.gateway != null && length(v.gateway) > 0 }
  sensitive   = true
}
output "hdinsight_hbase_clusters_https_endpoint" {
  ...
  value       = { for k, v in azurerm_hdinsight_hbase_cluster.hdinsight_hbase_clusters : k => v.https_endpoint if v.https_endpoint != null && length(v.https_endpoint) > 0 }
}
output "hdinsight_hbase_clusters_location" {
  ...
  value       = { for k, v in azurerm_hdinsight_hbase_cluster.hdinsight_hbase_clusters : k => v.location if v.location != null && length(v.location) > 0 }
}
output "hdinsight_hbase_clusters_metastores" {
  ...
  value       = { for k, v in azurerm_hdinsight_hbase_cluster.hdinsight_hbase_clusters : k => one(v.metastores) if v.metastores != null && length(v.metastores) > 0 }
  sensitive   = true
}
output "hdinsight_hbase_clusters_monitor" {
  ...
  value       = { for k, v in azurerm_hdinsight_hbase_cluster.hdinsight_hbase_clusters : k => one(v.monitor) if v.monitor != null && length(v.monitor) > 0 }
  sensitive   = true
}
output "hdinsight_hbase_clusters_name" {
  ...
  value       = { for k, v in azurerm_hdinsight_hbase_cluster.hdinsight_hbase_clusters : k => v.name if v.name != null && length(v.name) > 0 }
}
output "hdinsight_hbase_clusters_network" {
  ...
  value       = { for k, v in azurerm_hdinsight_hbase_cluster.hdinsight_hbase_clusters : k => one(v.network) if v.network != null && length(v.network) > 0 }
}
output "hdinsight_hbase_clusters_private_link_configuration" {
  ...
  value       = { for k, v in azurerm_hdinsight_hbase_cluster.hdinsight_hbase_clusters : k => one(v.private_link_configuration) if v.private_link_configuration != null && length(v.private_link_configuration) > 0 }
}
output "hdinsight_hbase_clusters_resource_group_name" {
  ...
  value       = { for k, v in azurerm_hdinsight_hbase_cluster.hdinsight_hbase_clusters : k => v.resource_group_name if v.resource_group_name != null && length(v.resource_group_name) > 0 }
}
output "hdinsight_hbase_clusters_roles" {
  ...
  value       = { for k, v in azurerm_hdinsight_hbase_cluster.hdinsight_hbase_clusters : k => one(v.roles) if v.roles != null && length(v.roles) > 0 }
  sensitive   = true
}
output "hdinsight_hbase_clusters_security_profile" {
  ...
  value       = { for k, v in azurerm_hdinsight_hbase_cluster.hdinsight_hbase_clusters : k => one(v.security_profile) if v.security_profile != null && length(v.security_profile) > 0 }
  sensitive   = true
}
output "hdinsight_hbase_clusters_ssh_endpoint" {
  ...
  value       = { for k, v in azurerm_hdinsight_hbase_cluster.hdinsight_hbase_clusters : k => v.ssh_endpoint if v.ssh_endpoint != null && length(v.ssh_endpoint) > 0 }
}
output "hdinsight_hbase_clusters_storage_account" {
  ...
  value       = { for k, v in azurerm_hdinsight_hbase_cluster.hdinsight_hbase_clusters : k => v.storage_account if v.storage_account != null && length(v.storage_account) > 0 }
  sensitive   = true
}
output "hdinsight_hbase_clusters_storage_account_gen2" {
  ...
  value       = { for k, v in azurerm_hdinsight_hbase_cluster.hdinsight_hbase_clusters : k => one(v.storage_account_gen2) if v.storage_account_gen2 != null && length(v.storage_account_gen2) > 0 }
}
output "hdinsight_hbase_clusters_tags" {
  ...
  value       = { for k, v in azurerm_hdinsight_hbase_cluster.hdinsight_hbase_clusters : k => v.tags if v.tags != null && length(v.tags) > 0 }
}
output "hdinsight_hbase_clusters_tier" {
  ...
  value       = { for k, v in azurerm_hdinsight_hbase_cluster.hdinsight_hbase_clusters : k => v.tier if v.tier != null && length(v.tier) > 0 }
}
output "hdinsight_hbase_clusters_tls_min_version" {
  ...
  value       = { for k, v in azurerm_hdinsight_hbase_cluster.hdinsight_hbase_clusters : k => v.tls_min_version if v.tls_min_version != null && length(v.tls_min_version) > 0 }
}
