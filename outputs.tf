...
output "hdinsight_hbase_clusters_component_version" {
  ...
  value       = { for k, v in azurerm_hdinsight_hbase_cluster.hdinsight_hbase_clusters : k => v.component_version if v.component_version != null && length(v.component_version) > 0 }
}
output "hdinsight_hbase_clusters_compute_isolation" {
  ...
  value       = { for k, v in azurerm_hdinsight_hbase_cluster.hdinsight_hbase_clusters : k => v.compute_isolation if v.compute_isolation != null && length(v.compute_isolation) > 0 }
}
...
output "hdinsight_hbase_clusters_extension" {
  ...
  value       = { for k, v in azurerm_hdinsight_hbase_cluster.hdinsight_hbase_clusters : k => v.extension if v.extension != null && length(v.extension) > 0 }
  sensitive   = true
}
output "hdinsight_hbase_clusters_gateway" {
  ...
  value       = { for k, v in azurerm_hdinsight_hbase_cluster.hdinsight_hbase_clusters : k => v.gateway if v.gateway != null && length(v.gateway) > 0 }
  sensitive   = true
}
...
output "hdinsight_hbase_clusters_metastores" {
  ...
  value       = { for k, v in azurerm_hdinsight_hbase_cluster.hdinsight_hbase_clusters : k => v.metastores if v.metastores != null && length(v.metastores) > 0 }
  sensitive   = true
}
output "hdinsight_hbase_clusters_monitor" {
  ...
  value       = { for k, v in azurerm_hdinsight_hbase_cluster.hdinsight_hbase_clusters : k => v.monitor if v.monitor != null && length(v.monitor) > 0 }
  sensitive   = true
}
...
output "hdinsight_hbase_clusters_network" {
  ...
  value       = { for k, v in azurerm_hdinsight_hbase_cluster.hdinsight_hbase_clusters : k => v.network if v.network != null && length(v.network) > 0 }
}
output "hdinsight_hbase_clusters_private_link_configuration" {
  ...
  value       = { for k, v in azurerm_hdinsight_hbase_cluster.hdinsight_hbase_clusters : k => v.private_link_configuration if v.private_link_configuration != null && length(v.private_link_configuration) > 0 }
}
...
output "hdinsight_hbase_clusters_roles" {
  ...
  value       = { for k, v in azurerm_hdinsight_hbase_cluster.hdinsight_hbase_clusters : k => v.roles if v.roles != null && length(v.roles) > 0 }
  sensitive   = true
}
output "hdinsight_hbase_clusters_security_profile" {
  ...
  value       = { for k, v in azurerm_hdinsight_hbase_cluster.hdinsight_hbase_clusters : k => v.security_profile if v.security_profile != null && length(v.security_profile) > 0 }
  sensitive   = true
}
...
output "hdinsight_hbase_clusters_storage_account_gen2" {
  ...
  value       = { for k, v in azurerm_hdinsight_hbase_cluster.hdinsight_hbase_clusters : k => v.storage_account_gen2 if v.storage_account_gen2 != null && length(v.storage_account_gen2) > 0 }
}
